        ...
        if(in_array($ext, $allowedExtensions)) {
               ...
               if($isUploaded) {
					...
					foreach($records as $row){
						...
						$query = "INSERT INTO occupancyprofile( `establishment`, `owner`, `typeofoccupancy`, `statapplication`, `address`, `dateiss`, `fsecoccupancy`, `fsicoccupancy`, `amountpaid`, `qrnumber`, `typeofapplication`, `dateinspect`, `inspectornum`, `dateinspectord`, `datefsec`, `datefsic`, `inspector`, `violation`, `classhazard`) 
