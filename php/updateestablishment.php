<?php
	...
	try {
		...
		$qry = "UPDATE establishmentprofile SET `establishment`= :a,  `owner`= :b, `statstab`= :c, `occupancy`= :d,  `statappli`= :e, `address`= :f, `dateiss`= :g, `fsicnumber`= :h, `amountpaid`= :i, `qrnumber`= :j, `typeapplic` = :k, `dateinspect` = :l, `inspectnum` = :m, `dateissueorder` = :n, `datefsic` = :o, `inspector` = :p, `violation` = :q, `remarks` = :r WHERE `establish` = :s";	
