	...
	try {
		...
		$qry = "";
					...
					if($ed == "add"){
					    ...
					    $qry= "INSERT INTO `occupancyprofile`( `establishment`, `owner`, `typeofoccupancy`, `statapplication`, `address`, `dateiss`, `fsecoccupancy`, `fsicoccupancy`, `amountpaid`, `qrnumber`, `typeofapplication`, `dateinspect`, `inspectornum`, `dateinspectord`, `datefsec`, `datefsic`, `inspector`, `violation`, `classhazard` ) VALUES " . 
					...
					if($ed == "add") {
						$checker = "SELECT * FROM `occupancyprofile` WHERE `occupancy` = :co";
