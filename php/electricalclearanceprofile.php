	...
	try {
		...
		$qry = "";
					...
					if($ed == "add"){
					    ...
					    $qry= "INSERT INTO `electricalclearance` (`buildingname`, `owner`, `location`, `fscecno`, `dateiss`, `kindofinstall`, `voltage`, `nophase`, `connectedload`, `maincircuit`, `installedby`, `prc`, `validuntil`, `ammountpaid`, `qrnumber`) VALUES " . 
					...
					if($ed == "add") {
						$checker = "SELECT * FROM electricalclearance WHERE clearance = :co";
