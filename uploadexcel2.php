        ...
        if(in_array($ext, $allowedExtensions)) {
               ...
               if($isUploaded) {
					...
					foreach($records as $row){
						...
						$query = "INSERT INTO electricalclearance(`buildingname`, `owner`, `location`, `fscecno`, `dateiss`, `kindofinstall`, `voltage`, `nophase`, `connectedload`, `maincircuit`, `installedby`, `prc`, `validuntil`, `ammountpaid`, `qrnumber`) 
