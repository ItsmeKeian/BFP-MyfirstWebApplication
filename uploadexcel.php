        ...
        if(in_array($ext, $allowedExtensions)) {
               ...
               if($isUploaded) {
					...
					foreach($records as $row){
						...
						$query = "INSERT INTO establishmentprofile(`establishment`, `owner`, `statstab`, `occupancy`, `statappli`, `address`, `dateiss`, `fsicnumber`, `amountpaid`, `qrnumber`, `typeapplic`, `dateinspect`, `inspectnum`, `dateissueorder`, `datefsic`, `inspector`, `violation`, `remarks`) 
